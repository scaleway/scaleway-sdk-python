...
class EnvironmentalFootprintV1Alpha1UserAPI(API):
    ...
    def get_impact_report_availability(
        self,
        *,
        ...
        ::
            ...
            result = api.get_impact_report_availability()
        """
    ...
    def download_impact_report(
        ...
        *,
        ...
        ::
            ...
            result = api.download_impact_report()
        """
