...
class AuditTrailV1Alpha1API(API):
    ...
    def list_custom_alert_rules(
        ...
        *,
        ...
        ::
            ...
            result = api.list_custom_alert_rules()
        """
    ...
    def list_custom_alert_rules_all(
        self,
        *,
        region: Optional[ScwRegion] = None,
        organization_id: Optional[str] = None,
        ...
        ::
            ...
            result = api.list_custom_alert_rules_all()
        """
    ...
    def enable_custom_alert_rules(
        ...
        *,
        ...
        ::
            ...
            result = api.enable_custom_alert_rules()
        """
    ...
    def disable_custom_alert_rules(
        self,
        *,
        region: Optional[ScwRegion] = None,
        organization_id: Optional[str] = None,
        ...
        ::
            ...
            result = api.disable_custom_alert_rules()
        """
    ...
    def set_enabled_custom_alert_rules(
        self,
        *,
        region: Optional[ScwRegion] = None,
        organization_id: Optional[str] = None,
        ...
        ::
            ...
            result = api.set_enabled_custom_alert_rules()
        """
    ...
    def create_custom_alert_rule(
        ...
        *,
        ...
        ::
            ...
            result = api.create_custom_alert_rule(
                name="example",
                query="example",
                occurrences=1,
            )
    ...
    def update_custom_alert_rule(
        ...
        *,
        ...
        ::
            ...
            result = api.update_custom_alert_rule(
    ...
    def delete_custom_alert_rule(
        ...
        *,
        ...
        ::
            ...
            result = api.delete_custom_alert_rule(
                custom_alert_rule_id="example",
            )
        """
    ...
    def test_custom_alert_rule(
        ...
        *,
        ...
        ::
            ...
            result = api.test_custom_alert_rule(
                query="example",
                occurrences=1,
            )
        """
    ...
    def retrieve_available_fields_for_custom_alert_rules(
        self,
        *,
        region: Optional[ScwRegion] = None,
        organization_id: Optional[str] = None,
        ...
        ::
            ...
            result = api.retrieve_available_fields_for_custom_alert_rules()
        """
