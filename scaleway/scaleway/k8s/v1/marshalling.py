...
def unmarshal_Pool(data: Any) -> Pool:
    ...
    if field is not None:
        ...
        args["kubelet_args"] = field(default_factory=dict)
...
def unmarshal_Version(data: Any) -> Version:
    ...
    if field is not None:
        ...
        args["available_cnis"] = field(default_factory=list)
...
def unmarshal_ClusterOpenIDConnectConfig(data: Any) -> ClusterOpenIDConnectConfig:
    ...
    if field is not None:
        ...
        args["groups_claim"] = field(default_factory=list)
    ...
    if field is not None:
        ...
        args["required_claim"] = field(default_factory=list)
...
def unmarshal_Cluster(data: Any) -> Cluster:
    ...
    if field is not None:
        ...
        args["feature_gates"] = field(default_factory=list)

    field = data.get("admission_plugins", None)
    if field is not None:
        args["admission_plugins"] = field
    else:
        args["admission_plugins"] = field(default_factory=list)
    ...
    if field is not None:
        ...
        args["apiserver_cert_sans"] = field(default_factory=list)
...
def unmarshal_Node(data: Any) -> Node:
    ...
    if field is not None:
        ...
        args["conditions"] = field(default_factory=dict)
...
def unmarshal_ListClusterAvailableTypesResponse(
    ...
    if field is not None:
        ...
        args["cluster_types"] = field(default_factory=list)
...
def unmarshal_ListClusterAvailableVersionsResponse(
    ...
    if field is not None:
        ...
        args["versions"] = field(default_factory=list)
...
def unmarshal_ListClustersResponse(data: Any) -> ListClustersResponse:
    ...
    if field is not None:
        ...
        args["clusters"] = field(default_factory=list)
...
def unmarshal_ListNodesResponse(data: Any) -> ListNodesResponse:
    ...
    if field is not None:
        ...
        args["nodes"] = field(default_factory=list)
