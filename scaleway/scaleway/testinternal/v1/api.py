...
from .types import (
    ...
    PostTagsMessage,
    PostTagsRequest,
    PostTransientRequest,
    PostWaitRequest,
    RegionalApiGetMetadataRequest,
    RegionalApiGetRegionRequest,
    RegionalApiGetServiceInfoRequest,
    RegionalApiPostEchoRequest,
    Transient,
    ZoneApiGetMetadataRequest,
    ZoneApiGetZoneRequest,
...
class TestinternalV1API(API):
    ...
    def post_tags(
        ...
        *,
        ...
        ::
            ...
            result = api.post_tags()
        """
        
        
        res = self._request(
            "PUT",
            f"/test-internal/v1/tags",
    ...
    def post_file(
        ...
        ::
            ...
            result = api.post_file()
        """
        
        
        res = self._request(
            "POST",
            f"/test-internal/v1/file",
            body={},
        )
    ...
    def post_scalar_types(
        ...
        *,
        ...
        res = self._request(
            "POST",
            f"/test-internal/v1/scalar-types",
    ...
    def post_wait(
        ...
        *,
        ...
        ::
            ...
            result = api.post_wait()
        """
        
        
        res = self._request(
            "POST",
            f"/test-internal/v1/wait",
    ...
    def get_region(
        ...
        res = self._request(
            "GET",
            f"/test-internal/v1/region",
        )

        self._throw_on_error(res)
        return unmarshal__GetRegionResponse(res.json())
        
    def post_organization_id(
        self,
        *,
        ...
        ::
            ...
            result = api.post_organization_id()
        """
        
        
        res = self._request(
            "POST",
            f"/test-internal/v1/organization-id",
    ...
    def post_deprecated_organization(
        self,
        *,
        ...
        ::
            ...
            result = api.post_deprecated_organization()
        """
        
        
        res = self._request(
            "POST",
            f"/test-internal/v1/deprecated-organization",
    ...
    def post_project_id(
        ...
        *,
        ...
        ::
            ...
            result = api.post_project_id()
        """
        
        
        res = self._request(
            "POST",
            f"/test-internal/v1/project-id",
    ...
    def post_deprecated_project(
        ...
        *,
        ...
        ::
            ...
            result = api.post_deprecated_project()
        """
        
        
        res = self._request(
            "POST",
            f"/test-internal/v1/deprecated-project",
    ...
    def post_one_of(
        ...
        *,
        ...
        """
        :param test: 
        One-Of ('some_oneof_name1'): at most one of 'test', 'test2' could be set.
        :param test2: 
        One-Of ('some_oneof_name1'): at most one of 'test', 'test2' could be set.
        :param test_nested: 
        One-Of ('some_oneof_name2'): at most one of 'test_nested', 'test3' could be set.
        :param test3: 
        One-Of ('some_oneof_name2'): at most one of 'test_nested', 'test3' could be set.
        ...
        ::
            ...
            result = api.post_one_of()
        """
        
        
        res = self._request(
            "POST",
            f"/test-internal/v1/oneof",
    ...
    def post_body_and_path_simple(
        ...
        *,
        ...
        ::
            ...
            result = api.post_body_and_path_simple(
                path="example",
                body="example",
            )
        """
    ...
    def post_body_and_path_simple2(
        self,
        *,
        path: str,
        body: str,
        ...
        ::
            ...
            result = api.post_body_and_path_simple2(
                path="example",
                body="example",
            )
        """
    ...
    def post_body_and_path_complex(
        self,
        *,
        path: str,
        ...
        ::
            ...
            result = api.post_body_and_path_complex(
                path="example",
            )
        """
    ...
    def post_body_and_path_and_query(
        self,
        *,
        path: str,
        query: str,
        ...
        ::
            ...
            result = api.post_body_and_path_and_query(
                path="example",
                query="example",
            )
        """
    ...
    def post_all_map_types(
        ...
        *,
        ...
        ::
            ...
            result = api.post_all_map_types()
        """
        
        
        res = self._request(
            "POST",
            f"/test-internal/v1/map",
    ...
    def post_all_types(
        ...
        *,
        ...
        repeated_nested_message: Optional[List[PostAllTypesMessageNestedMessage]] = None,
        ...
        :param oneof_uint32: 
        One-Of ('oneof_field'): at most one of 'oneof_uint32', 'oneof_nested_message', 'oneof_string', 'oneof_bytes' could be set.
    ...
    def post_all_optional(
        ...
        *,
        ...
        optional_nested_message_with_optional: Optional[PostAllOptionalMessageNestedMessageWithOptional] = None,
        lazy_nested_message_with_optional: Optional[PostAllOptionalMessageNestedMessageWithOptional] = None,
        ...
        res = self._request(
            "POST",
            f"/test-internal/v1/alloptional",
    ...
    def post_complex_validate(
        ...
        *,
        ...
        ::
            ...
            result = api.post_complex_validate()
        """
        
        
        res = self._request(
            "POST",
            f"/test-internal/v1/complex-validate",
    ...
    def list_characters(
        ...
        *,
        ...
        ::
            ...
            result = api.list_characters()
        """
        
        
        res = self._request(
            "GET",
            f"/test-internal/v1/characters",
            params={
                "name": name,
                "order_by": order_by,
                "page": page,
    ...
    def list_characters_all(
        ...
        *,
        ...
        ::
            ...
            result = api.list_characters_all()
        """
    ...
    def post_echo_time_series(
        ...
        *,
        ...
        ::
            ...
            result = api.post_echo_time_series()
        """
        
        
        res = self._request(
            "POST",
            f"/test-internal/v1/echo-timeseries",
    ...
    def post_transient(
        ...
        ::
            ...
            result = api.post_transient()
        """
        
        
        res = self._request(
            "POST",
            f"/test-internal/v1/transients",
            body={},
        )
    ...
    def wait_for_transient(
        self,
        *,
        transient_id: str,
        options: Optional[WaitForOptions[Transient, bool]] = None,
    ) -> Transient:
        """
        :param transient_id: 
        :return: :class:`Transient <Transient>`
