...
class PostAllOptionalMessage:
    ...
    optional_nested_message_with_optional: Optional[PostAllOptionalMessageNestedMessageWithOptional]
    
    lazy_nested_message_with_optional: Optional[PostAllOptionalMessageNestedMessageWithOptional]
