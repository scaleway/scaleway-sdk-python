...
class AnnotationsV1API(API):
    ...
    def delete_all_values_matching_key(
        self,
        *,
        key_id: str,
    ) -> DeleteAllValuesMatchingKeyResponse:
        ...
        ::
            ...
            result = api.delete_all_values_matching_key(
                key_id="example",
            )
        """
    ...
    def list_all_keys_and_values(
        ...
        *,
        ...
        ::
            ...
            result = api.list_all_keys_and_values()
        """
    ...
    def delete_all_bindings_matching_value(
        self,
        *,
        value_id: str,
    ) -> DeleteAllBindingsMatchingValueResponse:
        ...
        ::
            ...
            result = api.delete_all_bindings_matching_value(
                value_id="example",
            )
        """
