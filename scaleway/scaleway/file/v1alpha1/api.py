...
class FileV1Alpha1API(API):
    ...
    def list_file_system_types(
        ...
        *,
        ...
        ::
            ...
            result = api.list_file_system_types()
        """
    ...
    def list_file_system_types_all(
        self,
        *,
        region: Optional[ScwRegion] = None,
        page: Optional[int] = None,
        ...
        ::
            ...
            result = api.list_file_system_types_all()
        """
    ...
    def wait_for_file_system(
        ...
        *,
        filesystem_id: str,
        region: Optional[ScwRegion] = None,
        options: Optional[WaitForOptions[FileSystem, bool]] = None,
    ) -> FileSystem:
        """
        Get filesystem details.
        Retrieve all properties and current status of a specific filesystem identified by its ID.
