...
class DomainStatusRecordStatus(str, Enum):
...
class DomainStatus:
    ...
    spf_record: Optional[DomainStatusSpfRecord]
    """
    The SPF record verification data.
    """

    dkim_record: Optional[DomainStatusDkimRecord]
    """
