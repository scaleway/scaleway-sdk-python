...
def unmarshal_Instance(data: Any) -> Instance:
    ...
    if field is not None:
        ...
        args["upgradable_version"] = field(default_factory=list)
    ...
    if field is not None:
        ...
        args["settings"] = field(default_factory=list)
    ...
    if field is not None:
        ...
        args["read_replicas"] = field(default_factory=list)
    ...
    if field is not None:
        ...
        args["init_settings"] = field(default_factory=list)
    ...
    if field is not None:
        ...
        args["maintenances"] = field(default_factory=list)
...
def unmarshal_InstanceMetrics(data: Any) -> InstanceMetrics:
    ...
    if field is not None:
        ...
        args["timeseries"] = field(default_factory=list)
...
def unmarshal_ListDatabaseBackupsResponse(data: Any) -> ListDatabaseBackupsResponse:
    ...
    if field is not None:
        ...
        args["database_backups"] = field(default_factory=list)
...
def unmarshal_EngineVersion(data: Any) -> EngineVersion:
    ...
    if field is not None:
        ...
        args["available_settings"] = field(default_factory=list)
    ...
    if field is not None:
        ...
        args["available_init_settings"] = field(default_factory=list)
...
def unmarshal_ListDatabaseEnginesResponse(data: Any) -> ListDatabaseEnginesResponse:
    ...
    if field is not None:
        ...
        args["engines"] = field(default_factory=list)
...
def unmarshal_ListInstanceLogsDetailsResponse(
    ...
    if field is not None:
        ...
        args["details"] = field(default_factory=list)
...
def unmarshal_ListInstanceLogsResponse(data: Any) -> ListInstanceLogsResponse:
    ...
    if field is not None:
        ...
        args["instance_logs"] = field(default_factory=list)
...
def unmarshal_NodeType(data: Any) -> NodeType:
    ...
    if field is not None:
        ...
        args["available_volume_types"] = field(default_factory=list)
...
def unmarshal_ListPrivilegesResponse(data: Any) -> ListPrivilegesResponse:
    ...
    if field is not None:
        ...
        args["privileges"] = field(default_factory=list)
