...
class InstanceV2Alpha1API(API):
    ...
    def list_server_compatible_types(
        self,
        *,
        server_id: str,
        zone: Optional[ScwZone] = None,
        ...
        ::
            ...
            result = api.list_server_compatible_types(
                server_id="example",
            )
        """
    ...
    def list_dedicated_pools(
        ...
        *,
        ...
        ::
            ...
            result = api.list_dedicated_pools()
        """
    ...
    def update_dedicated_pool(
        ...
        *,
        ...
        ::
            ...
            result = api.update_dedicated_pool(
                dedicated_pool_id="example",
            )
        """
    ...
    def list_dedicated_pool_server_types(
        self,
        *,
        dedicated_pool_id: str,
        zone: Optional[ScwZone] = None,
        ...
        ::
            ...
            result = api.list_dedicated_pool_server_types(
                dedicated_pool_id="example",
            )
        """
