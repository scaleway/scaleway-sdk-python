...
def unmarshal_SecurityGroupRule(data: Any) -> SecurityGroupRule:
    ...
    if field is not None:
        ...
        args["protocol"] = SecurityGroupRuleProtocol.UNKNOWN_PROTOCOL

    field = data.get("direction", None)
    if field is not None:
        args["direction"] = field
    else:
        args["direction"] = SecurityGroupRuleDirection.UNKNOWN_DIRECTION

    field = data.get("action", None)
    if field is not None:
        args["action"] = field
    else:
        args["action"] = SecurityGroupRuleAction.UNKNOWN_ACTION
...
def unmarshal_PlacementGroup(data: Any) -> PlacementGroup:
    ...
    if field is not None:
        ...
        args["policy_type"] = PlacementGroupPolicyType.UNKNOWN_POLICY_TYPE
...
def unmarshal_Snapshot(data: Any) -> Snapshot:
    ...
    if field is not None:
        ...
        args["volume_type"] = SnapshotVolumeType.UNKNOWN_VOLUME_TYPE
    ...
    field = data.get("base_volume_id", None)
    if field is not None:
        args["base_volume_id"] = field
    else:
        args["base_volume_id"] = None
...
def unmarshal_Volume(data: Any) -> Volume:
    ...
    if field is not None:
        ...
        args["volume_type"] = VolumeVolumeType.UNKNOWN_VOLUME_TYPE
...
def unmarshal_ServerSummary(data: Any) -> ServerSummary:
    ...
    if field is not None:
        ...
        args["architecture"] = ServerArchitecture.UNKNOWN_ARCHITECTURE
...
def unmarshal_VolumeType(data: Any) -> VolumeType:
    ...
    if field is not None:
        ...
        args["name"] = VolumeVolumeType.UNKNOWN_VOLUME_TYPE
...
def unmarshal_ResourceCounts(data: Any) -> ResourceCounts:
    ...
    if field is not None:
        ...
        args["servers_by_type"] = {}

    field = data.get("security_groups", None)
    if field is not None:
        args["security_groups"] = field
    else:
        args["security_groups"] = 0

    field = data.get("placement_groups", None)
    if field is not None:
        args["placement_groups"] = field
    else:
        args["placement_groups"] = 0
...
def unmarshal_CreateTemplateRequestVolumeTemplate(
    ...
    if field is not None:
        ...
        args["volume_type"] = (
            CreateServerRequestServerVolumeVolumeType.UNKNOWN_VOLUME_TYPE
        )
...
def marshal_VolumeApiCreateSnapshotRequest(
    ...
    if request.base_volume_id is not None:
        output["base_volume_id"] = request.base_volume_id
...
def marshal_VolumeApiCreateVolumeRequest(
    ...
    if request.base_snapshot_id is not None:
        output["base_snapshot_id"] = request.base_snapshot_id
...
def marshal_VolumeApiExportSnapshotToObjectStorageRequest(
    ...
    if request.object_key is not None:
        output["object_key"] = request.object_key

    return output


def marshal_VolumeApiImportSnapshotFromObjectStorageRequest(
...
def marshal_VolumeApiUpdateSnapshotRequest(
...
def marshal_VolumeApiUpdateVolumeRequest(
