...
def unmarshal_Domain(data: Any) -> Domain:
    ...
    if field is not None:
        ...
        args["epp_code"] = field(default_factory=list)
    ...
    if field is not None:
        ...
        args["dns_zones"] = field(default_factory=list)
    ...
    if field is not None:
        ...
        args["linked_products"] = field(default_factory=list)
...
def unmarshal_ListDNSZoneNameserversResponse(
    ...
    if field is not None:
        ...
        args["ns"] = field(default_factory=list)
...
def unmarshal_ListTldsResponse(data: Any) -> ListTldsResponse:
    ...
    if field is not None:
        ...
        args["tlds"] = field(default_factory=list)
...
def unmarshal_SearchAvailableDomainsResponse(
    ...
    if field is not None:
        ...
        args["available_domains"] = field(default_factory=list)
