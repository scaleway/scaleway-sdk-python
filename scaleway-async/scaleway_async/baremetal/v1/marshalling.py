...
def unmarshal_ServerInstall(data: Any) -> ServerInstall:
    ...
    if field is not None:
        ...
        args["ssh_key_ids"] = field(default_factory=list)
...
def unmarshal_Offer(data: Any) -> Offer:
    ...
    if field is not None:
        ...
        args["cpus"] = field(default_factory=list)
    ...
    if field is not None:
        ...
        args["memories"] = field(default_factory=list)
    ...
    if field is not None:
        ...
        args["persistent_memories"] = field(default_factory=list)
    ...
    if field is not None:
        ...
        args["raid_controllers"] = field(default_factory=list)

    field = data.get("incompatible_os_ids", None)
    if field is not None:
        args["incompatible_os_ids"] = field
    else:
        args["incompatible_os_ids"] = field(default_factory=list)
    ...
    if field is not None:
        ...
        args["gpus"] = field(default_factory=list)
