...
class CockpitV1RegionalAPI(API):
    ...
    async def create_exporter(
        ...
        *,
        ...
        ::
            ...
            result = await api.create_exporter(
    ...
    async def list_exporters(
        ...
        *,
        ...
        ::
            ...
            result = await api.list_exporters()
        """
    ...
    async def list_exporters_all(
        ...
        *,
        ...
        ::
            ...
            result = await api.list_exporters_all()
        """
    ...
    async def wait_for_exporter(
        self,
        *,
        exporter_id: str,
        region: Optional[ScwRegion] = None,
        options: Optional[
            WaitForOptions[Exporter, Union[bool, Awaitable[bool]]]
        ] = None,
    ) -> Exporter:
        """
        Get a data export.
    ...
    async def delete_exporter(
        ...
        *,
        ...
        ::
            ...
            result = await api.delete_exporter(
                exporter_id="example",
            )
        """
    ...
    async def update_exporter(
        ...
        *,
        ...
        ::
            ...
            result = await api.update_exporter(
                exporter_id="example",
            )
        """
