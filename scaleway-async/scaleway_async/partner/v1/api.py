...
class PartnerV1API(API):
    ...
    async def request_admin_role(
        ...
        *,
        ...
        ::
            ...
            result = await api.request_admin_role(
                username="example",
                email="example",
                password="example",
            )
    ...
    async def create_organization(
        ...
        *,
        ...
        ::
            ...
            result = await api.create_organization(
                partner_id="example",
                email="example",
    ...
    async def list_organizations_all(
        self,
        *,
        page_size: Optional[int] = None,
        page: Optional[int] = None,
        ...
        ::
            ...
            result = await api.list_organizations_all()
        """
    ...
    async def lock_organization(
        ...
        *,
        ...
        ::
            ...
            result = await api.lock_organization()
        """
    ...
    async def unlock_organization(
        ...
        *,
        ...
        ::
            ...
            result = await api.unlock_organization()
        """
    ...
    async def update_organization(
        ...
        *,
        ...
        ::
            ...
            result = await api.update_organization()
        """
