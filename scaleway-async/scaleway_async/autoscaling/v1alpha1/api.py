...
class AutoscalingV1Alpha1API(API):
    ...
    async def list_instance_groups_all(
        self,
        *,
        zone: Optional[ScwZone] = None,
        order_by: Optional[ListInstanceGroupsRequestOrderBy] = None,
    ...
    async def update_instance_template(
        self,
        *,
        template_id: str,
        zone: Optional[ScwZone] = None,
    ...
    async def list_instance_templates_all(
        self,
        *,
        zone: Optional[ScwZone] = None,
        order_by: Optional[ListInstanceTemplatesRequestOrderBy] = None,
    ...
    async def create_instance_policy(
        self,
        *,
        name: str,
    ...
    async def update_instance_policy(
        self,
        *,
        policy_id: str,
        zone: Optional[ScwZone] = None,
    ...
    async def list_instance_policies_all(
        self,
        *,
        instance_group_id: str,
        zone: Optional[ScwZone] = None,
    ...
    async def delete_instance_policy(
        self,
        *,
        policy_id: str,
        zone: Optional[ScwZone] = None,
    ...
    async def list_instance_group_events(
        self,
        *,
        instance_group_id: str,
        zone: Optional[ScwZone] = None,
    ...
    async def list_instance_group_events_all(
        self,
        *,
        instance_group_id: str,
        zone: Optional[ScwZone] = None,
