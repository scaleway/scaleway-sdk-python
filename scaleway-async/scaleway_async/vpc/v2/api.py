...
class VpcV2API(API):
    ...
    async def enable_object_storage_private_access(
        self,
        *,
        vpc_id: str,
        region: Optional[ScwRegion] = None,
        ...
        ::
            ...
            result = await api.enable_object_storage_private_access(
                vpc_id="example",
            )
        """
    ...
    async def disable_object_storage_private_access(
        self,
        *,
        vpc_id: str,
        region: Optional[ScwRegion] = None,
        ...
        ::
            ...
            result = await api.disable_object_storage_private_access(
                vpc_id="example",
            )
        """
    ...
    async def add_private_network_object_storage_private_access(
        self,
        *,
        vpc_id: str,
        private_network_id: str,
        ...
        ::
            ...
            result = await api.add_private_network_object_storage_private_access(
                vpc_id="example",
                private_network_id="example",
            )
        """
    ...
    async def set_private_networks_object_storage_private_access(
        self,
        *,
        vpc_id: str,
        ...
        ::
            ...
            result = await api.set_private_networks_object_storage_private_access(
                vpc_id="example",
                private_network_ids=[],
            )
        """
    ...
    async def delete_private_network_object_storage_private_access(
        self,
        *,
        vpc_id: str,
        private_network_id: str,
        ...
        ::
            ...
            result = await api.delete_private_network_object_storage_private_access(
                vpc_id="example",
                private_network_id="example",
            )
        """
