...
class MessageqV1Alpha1API(API):
    ...
    async def create_deployment(
        ...
        *,
        ...
        :param node_type: Node type to use.
        :param version: The MessageQ version to use.
        ...
        :param volume: Volume for storing data.
        ...
        res = self._request(
            "POST",
            f"/messageq/v1alpha1/regions/{param_region}/deployments",
    ...
    async def update_deployment(
        ...
        *,
        ...
        res = self._request(
            "PATCH",
            f"/messageq/v1alpha1/regions/{param_region}/deployments/{param_deployment_id}",
    ...
    async def upgrade_deployment(
        ...
        *,
        ...
        :param deployment_id: ID of the deployment.
        :param region: Region to target. If none is passed will use default region from the config.
        :param node_count: Target number of nodes.
        One-Of ('upgrade_target'): at most one of 'node_count', 'volume_size_bytes' could be set.
        :param volume_size_bytes: Target volume size.
        One-Of ('upgrade_target'): at most one of 'node_count', 'volume_size_bytes' could be set.
        :return: :class:`Deployment <Deployment>`
        ...
        ::
            ...
            result = await api.upgrade_deployment(
                deployment_id="example",
            )
        """
        ...
        res = self._request(
            "POST",
            f"/messageq/v1alpha1/regions/{param_region}/deployments/{param_deployment_id}/upgrade",
    ...
    async def list_deployments(
        ...
        *,
        ...
        :param region: Region to target. If none is passed will use default region from the config.
        :param organization_id: Organization ID to filter for, only deployments from this Organization will be returned.
        :param project_id: Project ID to filter for, only deployments from this Project will be returned.
        :param order_by: Sort order for deployments in the response.
    ...
    async def list_versions(
        ...
        *,
        ...
        :param region: Region to target. If none is passed will use default region from the config.
        :param order_by: Sort order for versions in the response.
        :param page: Page number to return, from the paginated results.
        :param page_size: Number of versions to return per page.
        :param version: Engine version to filter for, only versions with this version will be returned.
        ...
        res = self._request(
            "GET",
            f"/messageq/v1alpha1/regions/{param_region}/versions",
            params={
                "order_by": order_by,
                "page": page,
                "page_size": page_size or self.client.default_page_size,
    ...
    async def list_node_types(
        ...
        *,
        ...
        :param order_by: Sort order for versions in the response.
        :param page: Page number to return, from the paginated results.
        :param page_size: Number of node types to return per page.
        ...
        res = self._request(
            "GET",
            f"/messageq/v1alpha1/regions/{param_region}/node-types",
            params={
                "order_by": order_by,
                "page": page,
                "page_size": page_size or self.client.default_page_size,
    ...
    async def create_endpoint(
        ...
        *,
        ...
        res = self._request(
            "POST",
            f"/messageq/v1alpha1/regions/{param_region}/endpoints",
    ...
    async def delete_endpoint(
        ...
        *,
        ...
        res = self._request(
            "DELETE",
            f"/messageq/v1alpha1/regions/{param_region}/endpoints/{param_endpoint_id}",
        )
    ...
    async def list_users(
        ...
        *,
        ...
        res = self._request(
            "GET",
            f"/messageq/v1alpha1/regions/{param_region}/deployments/{param_deployment_id}/users",
            params={
                "name": name,
                "order_by": order_by,
                "page": page,
    ...
    async def update_user(
        ...
        *,
        ...
        res = self._request(
            "PATCH",
            f"/messageq/v1alpha1/regions/{param_region}/deployments/{param_deployment_id}/users/{param_username}",
    ...
    async def download_deployment_certificate_authority(
        self,
        *,
        deployment_id: str,
        region: Optional[ScwRegion] = None,
        ...
        ::
            ...
            result = await api.download_deployment_certificate_authority(
                deployment_id="example",
            )
        """
