...
def unmarshal_PrivateNetwork(data: Any) -> PrivateNetwork:
    ...
    if field is not None:
        ...
        args["service_ips"] = field(default_factory=list)
...
def unmarshal_Cluster(data: Any) -> Cluster:
    ...
    if field is not None:
        ...
        args["cluster_settings"] = field(default_factory=list)
    ...
    if field is not None:
        ...
        args["acl_rules"] = field(default_factory=list)
    ...
    if field is not None:
        ...
        args["upgradable_versions"] = field(default_factory=list)
