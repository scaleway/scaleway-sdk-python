...
class IpfsV1Alpha1IpnsAPI(API):
    ...
    async def wait_for_name(
        ...
        *,
        name_id: str,
        region: Optional[Region] = None,
        options: Optional[WaitForOptions[Name, Union[bool, Awaitable[bool]]]] = None,
    ) -> Name:
        """
        Get information about a name.
        Retrieve information about a specific name.
    ...
    async def export_key_name(
        ...
        *,
        ...
        ::
            ...
            result = await api.export_key_name(
                name_id="example",
            )
        """
    ...
    async def import_key_name(
        ...
        *,
        ...
        ::
            ...
            result = await api.import_key_name(
                name="example",
                private_key="example",
                value="example",
            )
