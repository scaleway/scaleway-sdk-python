...
class BillingV2API(API):
    ...
    async def list_budgets_all(
        ...
        *,
        ...
        ::
            ...
            result = await api.list_budgets_all()
        """
    ...
    async def create_budget_alert(
        ...
        *,
        ...
        ::
            ...
            result = await api.create_budget_alert(
                budget_id="example",
                threshold=1,
            )
        """
    ...
    async def update_budget_alert(
        ...
        *,
        ...
        ::
            ...
            result = await api.update_budget_alert(
    ...
    async def delete_budget_alert(
        ...
        *,
        ...
        ::
            ...
            result = await api.delete_budget_alert(
                budget_alert_id="example",
            )
        """
    ...
    async def create_budget_alert_notification(
        ...
        *,
        ...
        ::
            ...
            result = await api.create_budget_alert_notification(
                budget_alert_id="example",
            )
        """
    ...
    async def update_budget_alert_notification(
        self,
        *,
        ...
        ::
            ...
            result = await api.update_budget_alert_notification(
    ...
    async def delete_budget_alert_notification(
        self,
        *,
        budget_alert_notification_id: str,
    ) -> None:
        ...
        ::
            ...
            result = await api.delete_budget_alert_notification(
                budget_alert_notification_id="example",
            )
        """
...
class BillingV2ElectronicBillingAPI(API):
    ...
    async def list_electronic_addresses(
        self,
        *,
        page: Optional[int] = None,
        page_size: Optional[int] = None,
        ...
        ::
            ...
            result = await api.list_electronic_addresses()
        """
    ...
    async def list_electronic_addresses_all(
        self,
        *,
        page: Optional[int] = None,
        page_size: Optional[int] = None,
        ...
        ::
            ...
            result = await api.list_electronic_addresses_all()
        """
    ...
    async def get_electronic_address(
        self,
        *,
        ...
        ::
            ...
            result = await api.get_electronic_address(
    ...
    async def create_electronic_address(
        self,
        *,
        value: str,
        organization_id: Optional[str] = None,
        ...
        ::
            ...
            result = await api.create_electronic_address(
                value="example",
            )
        """
    ...
    async def update_electronic_address(
        self,
        *,
        electronic_address_id: str,
        ...
        ::
            ...
            result = await api.update_electronic_address(
                electronic_address_id="example",
            )
        """
    ...
    async def delete_electronic_address(
        self,
        *,
        electronic_address_id: str,
    ) -> None:
        ...
        ::
            ...
            result = await api.delete_electronic_address(
                electronic_address_id="example",
            )
        """
