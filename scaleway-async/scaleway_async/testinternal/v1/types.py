...
class PostAllTypesMessage:
    ...
    singular_nested_message: PostAllTypesMessageNestedMessage
...
class ComplexValidateMsg:
    ...
    nested: ComplexValidateMsg

    int_const: int

    bool_const: bool

    another: ComplexValidateMsg
...
class PostAllOptionalMessage:
    ...
    nested_message: PostAllOptionalMessageNestedMessage
...
class PostBodyAndPathAndQueryMessage:
    ...
    body: PostBodyAndPathSimpleMessage
