...
`scaleway-sdk-python` is Apache 2.0 licensed and accepts contributions via GitHub.
...
- The version of `scaleway-sdk-python` you are using (1.3.7, main, ...)
- Python version
...
- Open a pull request against `scaleway-sdk-python` master branch that follows [PR guidelines](#pull-request-guidelines)
...
- **Don't forget commenting code** to help reviewers understand and to keep [our Go Report Card](https://goreportcard.com/report/github.com/scaleway/scaleway-sdk-python) at A+
